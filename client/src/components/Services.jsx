...
(
    <div className='flex flex-row justify-start items-center white-glassmorphism p-3 m-2 cursor-pointer hover:shadow-xl'>
        ...
        <div className='ml-5 flex flex-col flex-1'>
            ...
            <h2 className='mt-2 text-white text-sm md:w-9/12'>{subtitle}</h2>
        </div>
    </div>
)
const Services = () =>
{
    return(
        <div className='flex flex-column md:flex-row w-full justify-center items-center gradient-bg-services'>
